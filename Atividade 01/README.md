# Atividade 01 - Aula 02: Marcos Históricos da Web - A Revolução do AJAX
...
### Principais Marcos Técnicos Explorados:
* **2005:** Jesse James Garrett cunha o termo AJAX.
* **Arquitetura:** Uso do objeto `XMLHttpRequest` para requisições em segundo plano.
* **Evolução de Performance:** O impacto do motor **V8 (Google Chrome)** na execução de JavaScript complexo.
